...
Immutable bootloader stored in the first flash slot. Validates the newest MCUboot image
signature before handing over execution. Cannot be updated in the field.
